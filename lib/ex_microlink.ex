defmodule ExMicrolink do
  ...
  ## Examples
      ...
      iex> res = ExMicrolink.run(%{url: "https://www.lapresse.ca/sports/hockey/2021-11-26/canadien-sabres/le-retour-de-joel-edmundson-devra-attendre.php"})
      iex> Map.put(elem(res, 1), :content_length, nil) # excluding unpredictable value
  ...
  def run(request) do
    ...
    |> case do
      ...
      cs ->
        ...
        |> Map.replace!(
          :query,
          to_string(Ecto.Changeset.apply_changes(cs))
        )
        |> to_string
        |> Req.get!(
